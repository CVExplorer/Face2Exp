...
def Cover(img, v, max_v, **kwarg):
    draw = PIL.ImageDraw.Draw(img)
    draw.rectangle((0, 0, 224, 50), fill=(0, 0, 0))
    return img
...
# #             (ShearY, 0.3, None),
            (Solarize, 256, None),
#             (TranslateXConst, 20, None),
#             (TranslateYConst, 20, None),
            (Cover, None, None),
            ]
    return augs
...
#         ops = []
#         ops.append(self.augment_pool[0])
#         print(self.augment_pool)
#         ops = random.sample(self.augment_pool,self.n)
#         print("RandAugment called.")
